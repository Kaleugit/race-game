...
export const BOT_DEFAULT_PARTS = Object.freeze({ tire: 'misto', gearbox: 'padrao', engine: 'e20', chassis: 'medio', tank: 'medio' });
 ...
 * @param {{ bot?: { parts?: { tire: string, gearbox: string, engine?: string, chassis?: string, tank?: string } } }} stage
 */
